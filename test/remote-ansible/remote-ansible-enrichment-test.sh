...
export MOCK_SRV_SUCCESS="http://cds-regression-mockserver/mock-$CI_PIPELINE_ID/remote-ansible/success"
export MOCK_SRV_FAIL="http://cds-regression-mockserver/mock-$CI_PIPELINE_ID/remote-ansible/failure"
